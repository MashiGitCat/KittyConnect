            ...
            <div className="catlistings__card-container">
              ...
              <div className="col-md-8 catlistings__card-text-container">
                <div className=" catlistings__card-texts">
                  ...
                  <h5 className="card-text catlistings__card-text">
                    We are bunch of kitties looking for lovely homes with lovely
                    huumans... We all have different cat love to give you.
                    Select the one that is puurfect fo you. Connect with your
                    own Kitty Today!
                  </h5>
                </div>
              </div>
